...
- Add PaymentStatus to SnapshotPayload.
...
- Support count usage-feature kind.

## [1.2.0] - 2026-05-25

### Added

- Add GraceDaysLeft helper.
...
- Error on redirect and surface 429 retry-after.
- Add device list/revoke and snapshot device limit.
